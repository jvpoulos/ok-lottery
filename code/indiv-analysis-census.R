...
plot.data.aux <- data.frame(y = c(lm.census[[1]]['Est'][1,],
                                  lm.census[[2]]['Est'][1,],
                                  lm.census[[3]]['Est'][1,],
                                  lm.census[[4]]['Est'][1,],
                                  lm.census[[5]]['Est'][1,],
...
plot.data.aux$x <- c(rep(paste("Farmer, N =", 
...
# Plot forest plots
plot.data.aux$x <- factor(plot.data.aux$x, levels=plot.data.aux$x) # reverse order
summary.plot.aux <- ForestPlot(plot.data.aux,xlab="Treatment effect",ylab="Outcome") + scale_y_continuous(labels = percent_format(), 
                                                                                                           limits = c(-0.25,0.25))

ggsave(paste0(data.directory,"plots/forest-census.png"), summary.plot.aux, width=8.5, height=11)  