...
census.county[[4]] <- census.county[[4]] %>%
  ...
  mutate(G = gini(c((farm09*4.9),(farm1019*14.5),(farm2049*34.5),(farm5099*74.5),(farm100*299.5),(farm500*749.5),(farm1000)*1000)),
         beta = (1+G)/(1-G),
         top.farms = farms*(1-(0.8)^(1/beta)), # number of large farms constituting 20% of all land in 1890
...
census.county[[i]]$S <- 1-(1-census.county[[i]]$top.farms.90/census.county[[i]]$farms)^(census.county[[i]]$beta)
}
...
census.county[[8]]$top.farms.90[interaction(census.county[[8]]$county, census.county[[8]]$state) %in% interaction(census.county[[4]]$county, census.county[[4]]$state)] <-top.farms.90[interaction(census.county[[4]]$county, census.county[[4]]$state) %in% interaction(census.county[[8]]$county, census.county[[8]]$state)]
census.county[[8]]$S <- 1-(1-census.county[[8]]$top.farms.90/census.county[[8]]$farms)^(census.county[[8]]$beta)
...
census.county[[9]]$top.farms.90[interaction(census.county[[9]]$county, census.county[[9]]$state) %in% interaction(census.county[[4]]$county, census.county[[4]]$state)] <-top.farms.90[interaction(census.county[[4]]$county, census.county[[4]]$state) %in% interaction(census.county[[9]]$county, census.county[[9]]$state)]
census.county[[9]]$S <- 1-(1-census.county[[9]]$top.farms.90/census.county[[9]]$farms)^(census.county[[9]]$beta)
...
census.county[[10]]$top.farms.90[interaction(census.county[[10]]$county, census.county[[10]]$state) %in% interaction(census.county[[4]]$county, census.county[[4]]$state)] <-top.farms.90[interaction(census.county[[4]]$county, census.county[[4]]$state) %in% interaction(census.county[[10]]$county, census.county[[10]]$state)]
census.county[[10]]$S <- 1-(1-census.county[[10]]$top.farms.90/census.county[[10]]$farms)^(census.county[[10]]$beta)
